...
from apps.paypal.standard.models import PayPalStandardBase
from apps.paypal.standard.conf import POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT
from apps.paypal.standard.pdt.signals import pdt_successful, pdt_failed
...
class PayPalPDT(PayPalStandardBase):
    ...
    def _verify_postback(self):
        ...
        from apps.paypal.standard.pdt.forms import PayPalPDTForm
        result = False
