...
from apps.paypal.standard.conf import *
from apps.paypal.standard.widgets import ValueHiddenInput, ReservedValueHiddenInput
...
class PayPalSharedSecretEncryptedPaymentsForm(PayPalEncryptedPaymentsForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from apps.paypal.standard.helpers import make_secret
