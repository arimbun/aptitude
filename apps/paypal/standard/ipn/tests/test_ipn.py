...
from apps.paypal.standard.models import ST_PP_CANCELLED
from apps.paypal.standard.ipn.models import PayPalIPN
from apps.paypal.standard.ipn.signals import (payment_was_successful,
